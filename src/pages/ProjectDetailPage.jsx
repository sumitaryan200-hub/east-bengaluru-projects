                  ...
                  {project.floorPlanOnRequest ? (
                    ...
                    <>
                      ...
                      {project.floorPlans?.[activeFloorPlan] && (
                        project.floorPlans[activeFloorPlan].image ? (
                          ...
                          <a
                            href={`https://wa.me/918102422651?text=${encodeURIComponent(`Hi, I would like to request the *${project.floorPlans[activeFloorPlan].type} Floor Plan* for *${project.name}*.\n\nKindly share at your earliest convenience. Thank you!`)}`}
                            target="_blank" rel="noopener noreferrer"
                            className="flex flex-col items-center justify-center gap-4 rounded-[16px] border-2 border-dashed border-[#25D366]/40 bg-white py-14 px-6 text-center hover:border-[#25D366] hover:bg-[#25D366]/5 transition-all duration-300"
                          >
                            ...
                            <div>
                              <p className="text-[16px] font-bold text-slate-800">Tap here to get {project.floorPlans[activeFloorPlan].type} Floor Plan</p>
                              <p className="mt-1 text-[13px] text-slate-500">Opens WhatsApp — we'll send it instantly</p>
                            </div>
                            <span className="inline-flex items-center gap-2 rounded-full bg-[#25D366] px-6 py-2.5 text-[13px] font-bold text-white shadow">
