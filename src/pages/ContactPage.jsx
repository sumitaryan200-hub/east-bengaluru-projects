    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <main>
        ...
        <section className="relative overflow-hidden border-b border-[#D4AF37]/10 py-24">
          <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(rgba(0,0,0,0.04)_1px,transparent_1px),linear-gradient(90deg,rgba(0,0,0,0.04)_1px,transparent_1px)] bg-[size:80px_80px]" />
          <div className="absolute left-1/2 top-1/2 h-[400px] w-[400px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#D4AF37] opacity-[0.08] blur-[120px] pointer-events-none" />
          <div className="relative mx-auto max-w-[900px] px-4 text-center sm:px-6">
            ...
            >
              ...
              <h1 className="text-[38px] font-bold leading-tight text-slate-900 sm:text-[52px]">
                Contact <span className="italic text-[#D4AF37]">EastProject</span>
              </h1>
              <p className="mt-4 text-[16px] leading-8 text-slate-600 max-w-[600px] mx-auto">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <ScrollReveal delay={0}>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group flex flex-col items-center gap-4 rounded-[24px] border border-slate-200 bg-slate-50 p-8 text-center transition-all duration-300 hover:border-[#25D366]/40 hover:shadow-[0_8px_30px_rgba(37,211,102,0.1)]"
              >
                ...
                <div>
                  ...
                  <div className="text-[20px] font-black text-slate-900">+91 81024 22651</div>
                  <div className="mt-2 text-[13px] text-slate-600">Message us anytime</div>
                </div>
            ...
            <ScrollReveal delay={0.1}>
              <a
                ...
                className="group flex flex-col items-center gap-4 rounded-[24px] border border-slate-200 bg-slate-50 p-8 text-center transition-all duration-300 hover:border-[#D4AF37]/40 hover:shadow-[0_8px_30px_rgba(212,175,55,0.08)]"
              >
                ...
                <div>
                  ...
                  <div className="text-[20px] font-black text-slate-900">+91 81024 22651</div>
                  <div className="mt-2 text-[13px] text-slate-600">Mon – Sat, 9am – 7pm</div>
                </div>
            ...
            <ScrollReveal delay={0.2}>
              <a
                ...
                className="group flex flex-col items-center gap-4 rounded-[24px] border border-slate-200 bg-slate-50 p-8 text-center transition-all duration-300 hover:border-sky-500/30 hover:shadow-[0_8px_30px_rgba(14,165,233,0.08)]"
              >
                ...
                <div>
                  ...
                  <div className="text-[16px] font-black text-slate-900 break-all">sumitaryan200@gmail.com</div>
                  <div className="mt-2 text-[13px] text-slate-600">We reply within 24 hours</div>
                </div>
        ...
        {/* ── About Us ── */}
        <section className="border-t border-slate-200 bg-gray-50 py-20">
          <div className="mx-auto max-w-[900px] px-4 sm:px-6">
            <ScrollReveal>
              <div className="rounded-[28px] border border-slate-200 bg-slate-50 p-8 sm:p-12">
                <div className="mb-2 text-[11px] font-black uppercase tracking-widest text-[#D4AF37]">About EastProject</div>
                <h2 className="text-[28px] font-bold text-slate-900 sm:text-[34px]">
                ...
                <div className="mt-10 grid gap-5 sm:grid-cols-3">
                  {[
                    ...
                    <div key={item.label} className="rounded-[16px] border border-slate-700 bg-white p-5 text-center">
                      <div className="text-3xl">{item.icon}</div>
                      <div className="mt-3 text-[28px] font-black text-[#D4AF37]">{item.stat}</div>
                      <div className="mt-1 text-[12px] font-bold uppercase tracking-wider text-slate-600">{item.label}</div>
                    </div>
                  ))}
                </div>
